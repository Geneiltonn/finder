...
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>               Admin Finder+             >\n";
print "\t>           By GENEILTON01                >\n";
print "\t>                                         >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";

print " ENTRE COM O SITE\n EXEMPLO: www.victim.com OU www.victim.com/path\n-> ";
$site=<STDIN>;
chomp $site;

print "\n";
print "-> SALVAR OS RESULTADOS EM UM ARQUIVO? S/N ";
$save=<STDIN>;
chomp $save;
...
print "-> Target: $site\n";
print "-> CODIGO FONTE SITE: $code\n";
print "-> PROCURANDO ADMIN DB...\n\n\n";
...
if ($save eq "n"){
print "NÃO SALVAR NO ARMAZENAMENTO\n"; }
}else{
print "[-] NÃO ENCONTRADO <- $final\n";
}
}
}
